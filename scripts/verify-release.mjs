...
invariant(DATABASE_SCHEMA_VERSION === 5, "Database schema version changed unexpectedly");
invariant(
...
const requiredFiles = [
  ...
  "docs/releases/v1.0-completion.md",
...
invariant(readme.includes("Current version: 1.0.0"), "README does not identify Version 1.0.0");
invariant(
...
process.stdout.write(
  `Release metadata verified: ${expectedVersion}, 48 stable tools, profile v1, database v${DATABASE_SCHEMA_VERSION}, provider API v${PROVIDER_PLUGIN_API_VERSION}.\n`,
);
