...
Version 1.0 can ask a local model to choose among the same 48 validated tools
...
Version 1.0 does not collect or store LM Studio API tokens. Disable optional
