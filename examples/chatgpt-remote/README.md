...
[official ChatGPT developer-mode guidance](https://help.openai.com/en/articles/12584461-developer-mode-apps-and-full-mcp-connectors-in-chatgpt-beta).
...
See [the complete ChatGPT installation guide](../../docs/installation/chatgpt.md).
